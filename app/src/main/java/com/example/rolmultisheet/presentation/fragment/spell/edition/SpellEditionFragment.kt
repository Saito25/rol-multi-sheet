...
class SpellEditionFragment : Fragment(R.layout.spell_edition_fragment) {
    ...
    private val viewModel: SpellEditionViewModel by viewModels {
        SpellEditionViewModelFactory(
            RoomRepository(
